...
import { DSMAppProvider } from '@/src/modules/deadly-maze-client/ui/context/DSMAppProvider';
import { DSMApp as DSMAppCore, DSMAppFactory } from '@/src/modules/deadly-maze-client/utils/dsm-app';
