...
import fragmentShader from '@/src/modules/snake-maze-client/utils/shaders/unknown/fragment.glsl';
import vertexShader from '@/src/modules/snake-maze-client/utils/shaders/unknown/vertex.glsl';
